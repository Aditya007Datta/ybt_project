...
import { downloadImage } from "../random";
    ...
    <div className="absolute bottom-0 left-0 right-0 m-2 hidden max-h-[94.5%] flex-col rounded-md bg-[#10131f] p-4 group-hover:flex">
      ...
      <div className="mt-5 flex items-center justify-between gap-2">
        <div className="flex items-center gap-2">
          <div className="bg-green-700 flex h-7 w-7 items-center justify-center rounded-full object-cover text-xs font-bold text-white">
            {name[0]}
          </div>
